...
const PlayerDetails = ({player}:{player:IPlayer}) => {
    ...
    return (
        <Dialog header="Header" visible={visible} position={"bottom"} modal style={{ width: '50vw' }}  onHide={() => onHide()}
                    draggable={false} resizable={false} maskClassName={classes.mask} dismissableMask={true} contentClassName={classes.content}
                        className={classes.dialog} showHeader={false}>
                            <div>
                                <h2 className={classes.h2}><b className={classes.b}>{player.firstname}</b> {player.lastname}</h2>
                                <div className={classes.country}>
                                    <img src={player.country?.picture} alt="Country flag" className={classes['country-image']} />
                                    <h3 className={classes.h3} style={{fontSize: '2.5vw', letterSpacing: '2.5vw'}}>{player.country?.code}</h3>
                                </div>
                            </div>
                    ...
                    <div className={classes.modal}>
                        ...
                        <div>
                            ...
                            <p className={classes.p}>22 / 05 / {player.data?.age !== undefined ? 2022-player.data?.age : null}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className={classes.p}>{player.data?.weight !== undefined ? player.data?.weight / 1000 : null} kg</p>
                        </div>
                        <div>
